...
- (void)viewDidLoad
{
    ...
    occupationLabel.text = @"4. Are you from UK, US, NZ, Canada or Ireland?";
...
-(IBAction)optionSelected:(id)sender
{
    ...
    switch (btnTapped.tag) {
        case 100:
        {
            ...
            mainDelegate.country = @"From US, UK, NZ, Canada or Ireland";
        ...
        case 101:
        {
            ...
            mainDelegate.country = @"Not From US, UK, NZ, Canada or Ireland";
            
            EnglishAbility *englishAbilityObj = [[EnglishAbility  alloc] init];
            [self.navigationController pushViewController:englishAbilityObj animated:YES];
